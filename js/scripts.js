...
$(document).ready(function() {
  ...
  // --------- SELECT END ---------------------
  // ---------- PHONE WRAP -----------------------
  $(".phone-wrap div").each(function() {
    $(this).click(function() {
      if ($(this).hasClass("active")) {
        $(".phone-wrap div").removeClass("active");
      } else {
        $(".phone-wrap div").removeClass("active");
        $(this).addClass("active");
      }
  ...
  function initPhone() {
    $(".phone-wrap ul li").each(function() {
      $(this).click(function() {
        $(this)
          .siblings()
          .removeClass("active");
        $(this).addClass("active");
        let divSelected = $(this)
          .closest(".phone-wrap")
          .find("div");
        ...
        //   .closest(".phone-wrap")
        //   .find("input");
        imgSelected.attr("src", newFlagSrc);
        divSelected.find("span").html($(this).data("phone"));
        // divSelected.children("img").attr("src", newFlagSrc);
        divSelected.removeClass("active");
        divSelected.attr("data-value", $(this).data("phone"));
        // inputSelected.attr("value", `${$(this).data("phone")}#${$(this).html()}`);
      });
    });
  }
  if (document.querySelector(".phone-wrap ul li")) {
    initPhone();
  }

  $("body").on("click", function(e) {
    if (!$(e.target).closest(".phone-wrap").length) {
      $(".phone-wrap span").removeClass("active");
    }
  });
